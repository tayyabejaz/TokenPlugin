...
function my_redirect() {
	?>
	<meta http-equiv="refresh" content="3; URL=http://security-01st.com/wp-admin/admin.php?page=buyads"> <?php
}
...
function ads($amount)
{
    ...
    $executeParams = array();
    $executeParams['from_user_id'] = '2a39d3e2-50ca-4876-9072-3f3e7189da4a';
    $executeParams['to_user_id'] = 'eb476135-7360-4318-b917-e365adb29290';
    $executeParams['action_id'] = '39724';
